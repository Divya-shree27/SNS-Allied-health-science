...
export const EventsPage = () => {
    ...
    ${PageHeader(
        'Events & Celebrations',
        'Experience the vibrant life at SNS College of Allied Health Science through our memorable events, celebrations, and activities',
        '/static/images/SNS College of Allied Health Science Web/Events.webp',
        'Events'
    )}
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="group relative overflow-hidden rounded-2xl shadow-lg cursor-pointer aspect-square">
                    ...
                    <div class="absolute top-4 left-4">
                        <span class="bg-sky-600 text-white px-3 py-1 rounded-full text-xs font-bold">Festival</span>
                    </div>
                </div>
                ...
                <div class="group relative overflow-hidden rounded-2xl shadow-lg cursor-pointer aspect-square">
                    ...
                    <div class="absolute inset-0 bg-gradient-to-t from-black/90 via-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
                        <div>
                            ...
                            <p class="text-white/90 text-sm mb-3">Our dedicated students of SNS College of Allied Health Science had stepped out of their classrooms and into nature as part of Green Day celebrations. Taken to the lush lawn areas, students were introduced to the importance of greenery, plants, and caring for our environment. A beautiful day filled with curiosity, smiles, and meaningful lessons—planting the seeds of environmental responsibility.</p>
                            <div class="flex items-center text-white/80 text-xs space-x-4 mb-3">
                                <span><i class="fas fa-calendar mr-1"></i> Jan 2026</span>
                    ...
                    <div class="absolute top-4 left-4">
                        <span class="bg-sky-600 text-white px-3 py-1 rounded-full text-xs font-bold">Environment</span>
                    </div>
                </div>

                <!-- Event 3: Nutrition & Wellness Awareness Program -->
                <div class="group relative overflow-hidden rounded-2xl shadow-lg cursor-pointer aspect-square">
                    <div class="absolute inset-0">
                        <img src="https://scontent-maa3-4.cdninstagram.com/v/t51.82787-15/612048914_18340162762235871_4589295776461399701_n.webp?_nc_cat=102&ig_cache_key=MzgwMzczNDU2NjQyMzk5Nzg0Mw%3D%3D.3-ccb7-5&ccb=7-5&_nc_sid=58cdad&efg=eyJ2ZW5jb2RlX3RhZyI6InhwaWRzLjEwODB4NzIwLnNkci5DMyJ9&_nc_ohc=SwoO0anUKZgQ7kNvwEHAjv7&_nc_oc=AdlC_Uqv_FiZKiEzwi762K48ex6vOXRjieKviXApXfKnCdjMK5tGDm5QzNUoPKqs050&_nc_ad=z-m&_nc_cid=0&_nc_zt=23&_nc_ht=scontent-maa3-4.cdninstagram.com&_nc_gid=mVC0gIw4aY5kbTMyjoe5MA&oh=00_AfsFFHCh3RLa_9-7AKNCISkZjzdzzalBvPIMPLUFawZlZw&oe=69877F45" alt="Nutrition Awareness Program" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent"></div>
                    </div>
                    <!-- Always visible title -->
                    <div class="absolute bottom-0 left-0 right-0 p-6 group-hover:opacity-0 transition-opacity duration-300">
                        <h3 class="text-white font-bold text-2xl">Nutrition & Wellness</h3>
                    </div>
                    <!-- Hover overlay with full details -->
                    <div class="absolute inset-0 bg-gradient-to-t from-black/90 via-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
                        <div>
                            <h3 class="text-white font-bold text-2xl mb-2">Nutrition & Wellness</h3>
                            <p class="text-white/90 text-sm mb-3">Our students of SNS College of Allied Health Science, organized an impactful nutrition screening and wellness program. Students explored healthy dietary practices while engaging in hands-on clinical counseling. This delightful activity encouraged creativity, clinical reasoning, and awareness about nutritious food in healthcare settings!</p>
                            <div class="flex items-center text-white/80 text-xs space-x-4 mb-3">
                                <span><i class="fas fa-calendar mr-1"></i> Jan 2026</span>
                                <span><i class="fas fa-utensils mr-1"></i> Student Life</span>
                            </div>
                    ...
                    <div class="absolute top-4 left-4">
                        <span class="bg-sky-500 text-white px-3 py-1 rounded-full text-xs font-bold">Activity</span>
                    </div>
                </div>
                ...
                <div class="group relative overflow-hidden rounded-2xl shadow-lg cursor-pointer aspect-square">
                    ...
                    <div class="absolute top-4 left-4">
                        <span class="bg-sky-600 text-white px-3 py-1 rounded-full text-xs font-bold">Celebration</span>
                    </div>
                </div>
                ...
                <div class="group relative overflow-hidden rounded-2xl shadow-lg cursor-pointer aspect-square">
                    ...
                    <div class="absolute top-4 left-4">
                        <span class="bg-blue-600 text-white px-3 py-1 rounded-full text-xs font-bold">Festival</span>
                    </div>
                </div>
                ...
                <div class="group relative overflow-hidden rounded-2xl shadow-lg cursor-pointer aspect-square">
                    ...
                    <div class="absolute inset-0 bg-gradient-to-t from-black/90 via-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
                        <div>
                            ...
                            <p class="text-white/90 text-sm mb-3">Our students of SNS College of Allied Health Science enjoyed an enriching educational tour to Thekkady, where learning met nature and adventure. From exploring the Periyar Wildlife Sanctuary to understanding biodiversity and conservation firsthand, the experience went beyond textbooks. Filled with teamwork, joy, and unforgettable memories!</p>
                            <div class="flex items-center text-white/80 text-xs space-x-4 mb-3">
                                <span><i class="fas fa-calendar mr-1"></i> Dec 2025</span>
                    ...
                    <div class="absolute top-4 left-4">
                        <span class="bg-sky-600 text-white px-3 py-1 rounded-full text-xs font-bold">Educational Tour</span>
                    </div>
                </div>
    ...
    <section class="py-16 bg-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 class="text-4xl font-bold text-gray-900 mb-6">Be Part of Our Vibrant Community</h2>
                Join SNS College of Allied Health Science and create unforgettable memories through our diverse events and celebrations!
            <a href="/admissions" class="inline-flex items-center bg-sky-500 hover:bg-sky-600 text-white px-8 py-4 rounded-xl font-bold text-lg shadow-xl transition">
