            ...
            <div class="grid md:grid-cols-2 gap-12">
                <div>
                    ...
                    <p class="text-lg text-gray-700 leading-relaxed mb-6">
                        SNS iHub is an initiative by SNS Institutions to foster startups by providing a prototyping space immersed in an ambience of creativity and our <strong class="text-sky-600">patented GenAI-powered Design Thinking framework</strong>.
                    </p>
                ...
                <div class="bg-sky-50 rounded-2xl p-8 border border-sky-100">
                    <h3 class="text-2xl font-bold mb-6">RADICAL Technologies</h3>
                    <ul class="space-y-3">
                        <li class="flex items-start"><i class="fas fa-robot text-sky-600 mr-3 mt-1"></i><span>Robotics & Automation</span></li>
                        <li class="flex items-start"><i class="fas fa-vr-cardboard text-sky-600 mr-3 mt-1"></i><span>AR/VR Technology</span></li>
                        <li class="flex items-start"><i class="fas fa-brain text-sky-600 mr-3 mt-1"></i><span>Data Science/AI/ML</span></li>
                        <li class="flex items-start"><i class="fas fa-network-wired text-sky-600 mr-3 mt-1"></i><span>IoT/Cybersecurity</span></li>
                        <li class="flex items-start"><i class="fas fa-wifi text-sky-600 mr-3 mt-1"></i><span>Communication Tech</span></li>
                        <li class="flex items-start"><i class="fas fa-cube text-sky-600 mr-3 mt-1"></i><span>Additive Manufacturing</span></li>
                        <li class="flex items-start"><i class="fas fa-code text-sky-600 mr-3 mt-1"></i><span>Low Code/No Code</span></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-5 gap-6">
                <div class="bg-white rounded-2xl p-6 shadow-lg card-hover">
                    <div class="w-16 h-16 bg-sky-100 rounded-full flex items-center justify-center mx-auto mb-4">
                        <i class="fas fa-city text-3xl text-sky-600"></i>
                    </div>
                ...
                <div class="bg-white rounded-2xl p-6 shadow-lg card-hover">
                    <div class="w-16 h-16 bg-sky-100 rounded-full flex items-center justify-center mx-auto mb-4">
                        <i class="fas fa-seedling text-3xl text-sky-600"></i>
                    </div>
                ...
                <div class="bg-white rounded-2xl p-6 shadow-lg card-hover">
                    <div class="w-16 h-16 bg-sky-100 rounded-full flex items-center justify-center mx-auto mb-4">
                        <i class="fas fa-car text-3xl text-sky-600"></i>
                    </div>
                ...
                <div class="bg-white rounded-2xl p-6 shadow-lg card-hover">
                    <div class="w-16 h-16 bg-sky-100 rounded-full flex items-center justify-center mx-auto mb-4">
                        <i class="fas fa-building text-3xl text-sky-600"></i>
                    </div>
                ...
                <div class="bg-white rounded-2xl p-6 shadow-lg card-hover">
                    <div class="w-16 h-16 bg-sky-50 rounded-full flex items-center justify-center mx-auto mb-4">
                        <i class="fas fa-futbol text-3xl text-sky-600"></i>
                    </div>
                ...
                <div class="bg-white rounded-2xl p-6 shadow-lg card-hover">
                    <div class="w-16 h-16 bg-sky-100 rounded-full flex items-center justify-center mx-auto mb-4">
                        <i class="fas fa-bolt text-3xl text-sky-600"></i>
                    </div>
                ...
                <div class="bg-white rounded-2xl p-6 shadow-lg card-hover col-span-full md:col-span-1 lg:col-start-3">
                    <div class="w-16 h-16 bg-sky-200 rounded-full flex items-center justify-center mx-auto mb-4">
                        <i class="fas fa-user-circle text-3xl text-sky-700"></i>
                    </div>
    ...
    <section class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                ...
                <p class="text-lg text-sky-600 font-semibold">Exposure to world's leading companies and consulting firms</p>
            </div>
            
            <!-- Tech Giants -->
            <div class="mb-12">
                <h3 class="text-3xl font-bold text-center mb-8 text-sky-600">Tech Giants Club</h3>
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
                    <!-- Meta -->
                    <div class="bg-white rounded-xl p-6 text-center card-hover shadow-lg border border-gray-100">
                        <div class="w-16 h-16 bg-blue-700 rounded-xl flex items-center justify-center mx-auto mb-4 shadow-lg">
                    ...
                    <!-- Microsoft -->
                    <div class="bg-white rounded-xl p-6 text-center card-hover shadow-lg border border-gray-100">
                        <div class="w-16 h-16 bg-gradient-to-br from-sky-500 to-blue-500 rounded-xl flex items-center justify-center mx-auto mb-4 shadow-lg">
                            <svg class="w-10 h-10 text-white" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <!-- Amazon -->
                    <div class="bg-white rounded-xl p-6 text-center card-hover shadow-lg border border-gray-100">
                        <div class="w-16 h-16 bg-sky-500 rounded-xl flex items-center justify-center mx-auto mb-4 shadow-lg">
                            <svg class="w-10 h-10 text-white" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <!-- Google -->
                    <div class="bg-white rounded-xl p-6 text-center card-hover shadow-lg border border-gray-100">
                        <div class="w-16 h-16 bg-gradient-to-r from-blue-600 via-sky-600 to-blue-600 rounded-xl flex items-center justify-center mx-auto mb-4 shadow-lg">
                            <svg class="w-10 h-10 text-white" viewBox="0 0 24 24" fill="currentColor">
            ...
            <!-- Consulting & Finance -->
            <div class="bg-gradient-to-br from-sky-50 to-blue-50 rounded-3xl p-8 shadow-lg border border-sky-100">
                <h3 class="text-3xl font-bold text-center mb-8 text-sky-600">Consulting & Finance Club</h3>
            ...
            <!-- Club Benefits -->
            <div class="mt-12 bg-gradient-to-r from-sky-600 to-blue-600 rounded-2xl p-8 text-white">
...
export const AboutPage = () => {
    ...
    <section class="py-24 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                <div class="relative">
                    <div class="absolute -top-4 -left-4 w-24 h-24 bg-sky-100 rounded-full mix-blend-multiply filter blur-xl opacity-70"></div>
                    ...
                    <div class="absolute bottom-8 right-8 bg-white/90 backdrop-blur p-6 rounded-xl shadow-lg max-w-xs">
                        <p class="text-sky-600 font-bold text-lg mb-1">Our Tagline</p>
                ...
                <div>
                    <div class="mb-12">
                        <span class="text-sky-600 font-bold tracking-wider uppercase text-sm mb-2 block">Our Vision</span>
                        <h2 class="text-3xl lg:text-4xl font-bold mb-6 text-gray-900">
                            Building an <span class="text-sky-600">Entrepreneurial Mindset</span>
                        </h2>
                        ...
                        <p class="text-lg text-gray-600 leading-relaxed">
                            <strong>Sincerity, Nobility, and Service</strong> are not just our core values—they are the guiding principles that shape every student's character at SNS College of Allied Health Science.
                        </p>
                    </div>

                    <div class="space-y-6">
                        <div class="flex items-start">
                            <div class="w-12 h-12 bg-sky-50 rounded-lg flex items-center justify-center flex-shrink-0 mr-4">
                                <i class="fas fa-brain text-xl text-sky-600"></i>
                            </div>
                            <div>
                                <h4 class="font-bold text-gray-900 text-lg">Design Thinking</h4>
                                <p class="text-gray-600 text-sm">Solving healthcare challenges with empathy and innovation.</p>
                            </div>
                        </div>
                        <div class="flex items-start">
                            <div class="w-12 h-12 bg-sky-50 rounded-lg flex items-center justify-center flex-shrink-0 mr-4">
                                <i class="fas fa-users text-xl text-sky-600"></i>
                            </div>
                            <div>
                                <h4 class="font-bold text-gray-900 text-lg">3P Culture</h4>
                                <p class="text-gray-600 text-sm">Purpose, Process, People driving medical excellence.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section class="py-24 bg-gray-50">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="text-center mb-16">
                        <span class="text-sky-600 font-bold tracking-wider uppercase text-sm mb-2 block">Our Mission</span>
                        ...
                        <div class="bg-white rounded-2xl overflow-hidden shadow-lg group hover:shadow-xl transition duration-300">
                            ...
                            <div class="p-8">
                                ...
                                <p class="text-gray-600 text-sm leading-relaxed">
                                    Practice Design Thinking-Based Academic Learning & Teaching. We move from rote memorization to active understanding and clinical excellence.
                                </p>
                            </div>
                        </div>
    ...
    <section class="py-24 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <span class="text-sky-600 font-bold tracking-wider uppercase text-sm mb-2 block">Our Leadership</span>
                ...
                <div class="bg-gray-50 rounded-2xl p-8 border border-gray-100 hover:shadow-lg transition duration-300">
                    <div class="flex items-center mb-6">
                        ...
                        <div>
                            ...
                            <p class="text-sky-600 text-sm font-semibold mt-1">Founder Chairman</p>
                        </div>
                    </div>
                    <div class="space-y-4">
                        <p class="text-gray-600 text-sm leading-relaxed italic">
                            "We believe that every student is a design thinker. Through our unique Design Thinking framework and 3P Culture, we prepare students not just for exams, but for their professional healthcare careers."
                        </p>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 rounded-2xl p-8 border border-gray-100 hover:shadow-lg transition duration-300">
                    <div class="flex items-center mb-6">
                        ...
                        <div>
                            ...
                            <p class="text-sky-600 text-sm font-semibold mt-1">Chairman / Correspondent</p>
                        </div>
                    </div>
                    <div class="space-y-4">
                        <p class="text-gray-600 text-sm leading-relaxed italic">
                            "Our mission is to nurture each student's unique professional potential through our 5 Pillars Mission, preparing them for specialized careers in Allied Health Sciences."
                        </p>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 rounded-2xl p-8 border border-gray-100 hover:shadow-lg transition duration-300">
                    <div class="flex items-center mb-6">
                        ...
                        <div>
                            ...
                            <p class="text-sky-600 text-sm font-semibold mt-1">Technical Director</p>
                        </div>
                    </div>
                    <div class="space-y-4">
                        <p class="text-gray-600 text-sm leading-relaxed italic">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-2 gap-12">
                <div>
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start">
                            <i class="fas fa-map-marker-alt text-3xl text-sky-600 mr-4"></i>
                            <div>
                                <h3 class="font-bold text-xl mb-2">Address</h3>
                                <p class="text-gray-700">SNS College of Allied Health Science,<br>Thudiyalur - Saravanampatti Road,<br>Vellakinar Post,<br>Coimbatore - 641029.</p>
                            </div>
                        </div>
                        <div class="flex items-start">
                            <i class="fas fa-phone text-3xl text-sky-600 mr-4"></i>
                            <div>
                        ...
                        <div class="flex items-start">
                            <i class="fas fa-envelope text-3xl text-sky-600 mr-4"></i>
                            <div>
                                <h3 class="font-bold text-xl mb-2">Email</h3>
                                <p class="text-gray-700">General: info@snscahs.org<br>Career: job@snsgroups.com</p>
                            </div>
                        </div>
                        <div class="flex items-start">
                            <i class="fas fa-clock text-3xl text-sky-600 mr-4"></i>
                            <div>
                ...
                <script>
                /* Placeholder + Asterisk Fix and College Branding */
                function fixBitrixForm() {
                    document.querySelectorAll('.b24-form-field').forEach(function (field) {
                        ...
                        const dropdownItems = field.querySelectorAll('.b24-form-dropdown-item');
                        
                        if (label && input) {
                            let text = label.textContent.replace(/\s*\*$/, '').trim();
                            
                            // School to College Terminology Mapping
                            text = text.replace(/Name of the Child/i, 'Name of the Student');
                            text = text.replace(/Admission To Grade/i, 'Program Interested In');
                            text = text.replace(/Parent Name/i, 'Guardian/Parent Name');
                            text = text.replace(/SNS Academy/i, 'SNS CAHS');
                            
                            let required = label.textContent.includes('*');
                            input.placeholder = required ? text + ' *' : text;
                            
                            // Update the label text as well if visible
                            label.innerHTML = required ? text + ' <span class="b24-form-control-required">*</span>' : text;
                        }

                        // Fix Dropdown Selected Values
                        const selectedValue = field.querySelector('.b24-form-control-not-empty');
                        if (selectedValue) {
                            selectedValue.textContent = selectedValue.textContent.replace(/SNS Academy/i, 'SNS CAHS');
                        }
                    });

                    // Fix the Submit button text
                    const submitBtn = document.querySelector('.b24-form-btn');
                    if (submitBtn && submitBtn.textContent.includes('Call me!!!')) {
                        submitBtn.textContent = 'Submit Inquiry';
                    }

                    // Fix any other text nodes that might contain Academy
                    const allTextNodes = document.createNodeIterator(
                        document.querySelector('.b24-form-wrapper') || document.body,
                        NodeFilter.SHOW_TEXT
                    );
                    let node;
                    while (node = allTextNodes.nextNode()) {
                        if (node.parentElement && !['SCRIPT', 'STYLE'].includes(node.parentElement.tagName)) {
                            node.textContent = node.textContent.replace(/SNS Academy/i, 'SNS CAHS');
                        }
                    }
                }

                // Run multiple times as Bitrix form loads asynchronously
                setTimeout(fixBitrixForm, 500);
                setTimeout(fixBitrixForm, 1000);
                setTimeout(fixBitrixForm, 2000);
                setTimeout(fixBitrixForm, 4000);
                </script>
            </div>
        </div>
    </section>
...
export const PlacementPage = () => {
    ...
    ${PageHeader(
        'Placement & Training',
        'Empowering Students for Global Healthcare Careers',
        '/static/images/pillar_industry.jpg',
        'Placement'
    )}
    ...
    <section class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-2 gap-12 items-center mb-20">
                <div>
                    <h2 class="text-4xl font-bold mb-6">Our Placement Philosophy</h2>
                    <p class="text-lg text-gray-700 leading-relaxed mb-6">
                        The Corporate Relations at SNS CAHS works tirelessly to bridge the gap between academic learning and industrial requirements. We provide comprehensive training to ensure our students are "Industry Ready" from day one.
                    </p>
                    <div class="space-y-4">
                        <div class="flex items-center">
                            <i class="fas fa-check-circle text-sky-600 mr-3"></i>
                            <span class="text-gray-800 font-medium">100% Placement Support for all eligible students</span>
                        </div>
                        <div class="flex items-center">
                            <i class="fas fa-check-circle text-sky-600 mr-3"></i>
                            <span class="text-gray-800 font-medium">Pre-placement Training & Soft Skill Workshops</span>
                        </div>
                        <div class="flex items-center">
                            <i class="fas fa-check-circle text-sky-600 mr-3"></i>
                            <span class="text-gray-800 font-medium">Internships in Leading Multi-specialty Hospitals</span>
                        </div>
                    </div>
                </div>
                <div class="bg-sky-50 rounded-2xl p-10 border border-sky-100">
                    <div class="grid grid-cols-2 gap-8">
                        <div class="text-center">
                            <div class="text-4xl font-black text-sky-600 mb-2">100%</div>
                            <div class="text-sm text-gray-600 uppercase tracking-wider font-bold">Placement Support</div>
                        </div>
                        <div class="text-center">
                            <div class="text-4xl font-black text-sky-600 mb-2">50+</div>
                            <div class="text-sm text-gray-600 uppercase tracking-wider font-bold">Hospital Partners</div>
                        </div>
                        <div class="text-center">
                            <div class="text-4xl font-black text-sky-600 mb-2">35+</div>
                            <div class="text-sm text-gray-600 uppercase tracking-wider font-bold">LPA Highest CTC</div>
                        </div>
                        <div class="text-center">
                            <div class="text-4xl font-black text-sky-600 mb-2">15+</div>
                            <div class="text-sm text-gray-600 uppercase tracking-wider font-bold">Industrial Tie-ups</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="py-12 border-y border-gray-100">
                <h3 class="text-2xl font-bold text-center mb-10 text-gray-500 uppercase tracking-widest">Our Top Recruiters & Clinical Partners</h3>
                <div class="flex flex-wrap justify-center items-center gap-12 opacity-60">
                    <span class="text-3xl font-black text-gray-400">APOLLO HOSPITALS</span>
                    <span class="text-3xl font-black text-gray-400">GEM HOSPITAL</span>
                    <span class="text-3xl font-black text-gray-400">KMCH</span>
                    <span class="text-3xl font-black text-gray-400">ROYAL CARE</span>
                    <span class="text-3xl font-black text-gray-400">MAX HEALTHCARE</span>
                </div>
            </div>
        </div>
    </section>
...
export const CareerPage = () => {
    ...
    ${PageHeader(
        'Careers at SNS CAHS',
        'Join Our Mission to Redesign Healthcare Education',
    ...
    <section class="py-16 bg-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                ...
                <p class="text-gray-600">Join a team of visionaries who are transforming healthcare education through Design Thinking.</p>
            </div>

            <div class="space-y-6">
                <div class="bg-gray-50 rounded-xl p-8 border border-gray-100 hover:shadow-md transition">
                    <div class="flex justify-between items-start mb-4">
                        <div>
                            <h3 class="text-xl font-bold">Professor / Associate Professor</h3>
                            <p class="text-sky-600 font-medium">Department of Cardiac Technology</p>
                        </div>
                        <span class="bg-sky-100 text-sky-700 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider">Academic</span>
                    </div>
                    <p class="text-gray-600 text-sm mb-6">We are looking for experienced academicians with a passion for clinical research and teaching excellence.</p>
                    <a href="/contact" class="text-sky-600 font-bold flex items-center hover:underline">
                        Apply Now <i class="fas fa-arrow-right ml-2 text-xs"></i>
                    </a>
                </div>
                ...
                <div class="bg-gray-50 rounded-xl p-8 border border-gray-100 hover:shadow-md transition">
                    <div class="flex justify-between items-start mb-4">
                        <div>
                            <h3 class="text-xl font-bold">Clinical Instructor</h3>
                            <p class="text-sky-600 font-medium">Department of Operation Theatre Technology</p>
                        </div>
                        <span class="bg-blue-100 text-blue-700 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider">Clinical</span>
                    </div>
                    <p class="text-gray-600 text-sm mb-6">Provide hands-on training to students in OT protocols and anesthesia procedures.</p>
                    <a href="/contact" class="text-sky-600 font-bold flex items-center hover:underline">
                        Apply Now <i class="fas fa-arrow-right ml-2 text-xs"></i>
                    </a>
                </div>
                ...
                <div class="bg-gray-50 rounded-xl p-8 border border-gray-100 hover:shadow-md transition">
                    <div class="flex justify-between items-start mb-4">
                        <div>
                            <h3 class="text-xl font-bold">Student Relation Manager</h3>
                            <p class="text-sky-600 font-medium">Admissions Department</p>
                        </div>
                        <span class="bg-green-100 text-green-700 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider">Administrative</span>
                    </div>
                    <p class="text-gray-600 text-sm mb-6">Counsel prospective students and manage the admission inquiry process.</p>
                    <a href="/contact" class="text-sky-600 font-bold flex items-center hover:underline">
                        Apply Now <i class="fas fa-arrow-right ml-2 text-xs"></i>
                    </a>
                </div>
            ...
            <div class="mt-16 bg-sky-600 rounded-2xl p-10 text-white text-center">
                <h3 class="text-2xl font-bold mb-4">Don't see a perfect fit?</h3>
                <p class="mb-8 opacity-90">Send your resume to our HR department and we'll reach out when a suitable position opens up.</p>
                <a href="mailto:job@snsgroups.com" class="bg-white text-sky-600 px-8 py-4 rounded-xl font-bold hover:bg-sky-50 transition shadow-lg">
                    Send Resume to job@snsgroups.com
                </a>
            </div>
        </div>
    </section>
...
export const AdmissionsPage = () => {
    ...
    ${PageHeader(
        'Admissions 2026-27',
        'Begin Your Journey to Medical Excellence',
        '/static/images/hero.png',
        'Admissions'
    )}
    ...
    <section class="py-16 bg-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="space-y-8">
                <div class="flex items-start">
                    <div class="w-12 h-12 bg-sky-100 rounded-full flex items-center justify-center flex-shrink-0 mr-6">
                        <span class="text-2xl font-bold text-sky-600">1</span>
                    </div>
                    <div>
                        <h3 class="text-2xl font-bold mb-2 text-gray-900">Register</h3>
                        <p class="text-gray-700">Visit our institution on any working day between 9:00 AM to 5:00 PM and register for the B.Sc. program of your choice.</p>
                    </div>
                </div>
                <div class="flex items-start">
                    <div class="w-12 h-12 bg-sky-100 rounded-full flex items-center justify-center flex-shrink-0 mr-6">
                        <span class="text-2xl font-bold text-sky-600">2</span>
                    </div>
                    <div>
                        <h3 class="text-2xl font-bold mb-2 text-gray-900">Counseling</h3>
                        <p class="text-gray-700">Participate in professional counseling to understand the scope of Allied Health Science programs and career paths.</p>
                    </div>
                </div>
                <div class="flex items-start">
                    <div class="w-12 h-12 bg-sky-100 rounded-full flex items-center justify-center flex-shrink-0 mr-6">
                        <span class="text-2xl font-bold text-sky-600">3</span>
                    </div>
                    <div>
                        <h3 class="text-2xl font-bold mb-2 text-gray-900">Interview</h3>
                        <p class="text-gray-700">A personal interview with our academic committee to assess your passion and suitability for the healthcare profession.</p>
                    </div>
                </div>
                <div class="flex items-start">
                    <div class="w-12 h-12 bg-sky-100 rounded-full flex items-center justify-center flex-shrink-0 mr-6">
                        <span class="text-2xl font-bold text-sky-600">4</span>
                    </div>
                    <div>
                        <h3 class="text-2xl font-bold mb-2 text-gray-900">Selection</h3>
                        <p class="text-gray-700">Admission will be granted based on academic merit and performance in the interview committee selection.</p>
                    </div>
                </div>
            </div>
        </div>
