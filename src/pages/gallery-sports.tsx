...
export const GalleryPage = () => {
    ...
    <!-- Life at SNS College of Allied Health Science -->
    <section class="py-16 bg-gradient-to-br from-blue-50 to-sky-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 class="text-4xl font-bold text-center mb-4">Life @ SNS CAHS</h2>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-2xl overflow-hidden shadow-xl card-hover">
                    <div class="h-64 relative overflow-hidden">
                        <img src="/static/images/SNS College of Allied Health Science Web/Colla Work.png" alt="Collaborative Work" class="w-full h-full object-cover">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent"></div>
                        <div class="absolute bottom-4 left-4 text-white">
                ...
                <div class="bg-white rounded-2xl overflow-hidden shadow-xl card-hover">
                    <div class="h-64 relative overflow-hidden">
                        <img src="/static/images/SNS College of Allied Health Science Web/Happy Envirn.png" alt="Happy Environment" class="w-full h-full object-cover">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent"></div>
                        <div class="absolute bottom-4 left-4 text-white">
    ...
    <section class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 class="text-4xl font-bold text-center mb-4 text-gray-900">College Campus</h2>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
                <div class="bg-gradient-to-br from-sky-50 to-blue-100 rounded-2xl p-8 shadow-lg border-b-4 border-sky-500">
                    <div class="w-20 h-20 bg-white rounded-full flex items-center justify-center mx-auto mb-6 shadow-md">
                        <i class="fas fa-building text-4xl text-sky-600"></i>
                    </div>
                    <h3 class="text-2xl font-bold text-center mb-4 text-gray-900">A Block</h3>
                    <p class="text-gray-700 text-center">Academic block with specialized clinical labs</p>
                </div>
                
                <div class="bg-gradient-to-br from-blue-50 to-sky-100 rounded-2xl p-8 shadow-lg border-b-4 border-blue-600">
                    <div class="w-20 h-20 bg-white rounded-full flex items-center justify-center mx-auto mb-6 shadow-md">
                        <i class="fas fa-university text-4xl text-sky-600"></i>
                    </div>
                    <h3 class="text-2xl font-bold text-center mb-4 text-gray-900">B Block</h3>
                    <p class="text-gray-700 text-center">Healthcare education wing with advanced facilities</p>
                </div>
                
                <div class="bg-gradient-to-br from-sky-100 to-blue-50 rounded-2xl p-8 shadow-lg border-b-4 border-sky-700">
                    <div class="w-20 h-20 bg-white rounded-full flex items-center justify-center mx-auto mb-6 shadow-md">
                        <i class="fas fa-landmark text-4xl text-sky-700"></i>
                    </div>
                    <h3 class="text-2xl font-bold text-center mb-4 text-gray-900">C Block</h3>
                    <p class="text-gray-700 text-center">Administrative and professional block</p>
                </div>
            </div>

            <div class="grid md:grid-cols-4 gap-6">
                <div class="bg-white rounded-xl p-6 shadow-md text-center border-t-2 border-sky-500">
                    <i class="fas fa-door-open text-4xl text-sky-600 mb-3"></i>
                    <h4 class="font-bold">Reception</h4>
                </div>
                <div class="bg-white rounded-xl p-6 shadow-md text-center border-t-2 border-sky-500">
                    <i class="fas fa-chalkboard text-4xl text-sky-600 mb-3"></i>
                    <h4 class="font-bold">Smart Classrooms</h4>
                </div>
                <div class="bg-white rounded-xl p-6 shadow-md text-center border-t-2 border-sky-500">
                    <i class="fas fa-flask text-4xl text-sky-600 mb-3"></i>
                    <h4 class="font-bold">Medical Labs</h4>
                </div>
                <div class="bg-white rounded-xl p-6 shadow-md text-center border-t-2 border-sky-500">
                    <i class="fas fa-user-md text-4xl text-sky-600 mb-3"></i>
                    <h4 class="font-bold">Clinic</h4>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-gradient-to-br from-sky-50 to-blue-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-2xl p-8 shadow-xl border-b-4 border-sky-600">
                    <div class="w-16 h-16 bg-sky-100 rounded-full flex items-center justify-center mb-6">
                        <i class="fas fa-atom text-3xl text-sky-600"></i>
                    </div>
                ...
                <div class="bg-white rounded-2xl p-8 shadow-xl border-b-4 border-sky-600">
                    <div class="w-16 h-16 bg-sky-100 rounded-full flex items-center justify-center mb-6">
                        <i class="fas fa-laptop-code text-3xl text-sky-600"></i>
                    </div>
                ...
                <div class="bg-white rounded-2xl p-8 shadow-xl">
                    <div class="w-16 h-16 bg-sky-100 rounded-full flex items-center justify-center mb-6">
                        <i class="fas fa-calculator text-3xl text-sky-600"></i>
                    </div>
                ...
                <div class="bg-white rounded-2xl p-8 shadow-xl">
                    <div class="w-16 h-16 bg-sky-100 rounded-full flex items-center justify-center mb-6">
                        <i class="fas fa-language text-3xl text-sky-600"></i>
                    </div>
    ...
    <section class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div class="bg-gradient-to-br from-sky-50 to-blue-50 rounded-xl p-6 shadow-sm">
                    <i class="fas fa-briefcase text-4xl text-sky-600 mb-4"></i>
                ...
                <div class="bg-gradient-to-br from-blue-50 to-sky-100 rounded-xl p-6 shadow-sm">
                ...
                <div class="bg-gradient-to-br from-sky-100 to-blue-50 rounded-xl p-6 shadow-sm">
                    <i class="fas fa-bus text-4xl text-sky-600 mb-4"></i>
                    <h3 class="text-xl font-bold mb-2">Transport</h3>
                    <p class="text-gray-600 text-sm">Safe and comfortable bus service</p>
                </div>
                
                <div class="bg-gradient-to-br from-blue-100 to-sky-50 rounded-xl p-6 shadow-sm">
                ...
                <div class="bg-gradient-to-br from-sky-50 to-sky-100 rounded-xl p-6 shadow-sm">
                    <i class="fas fa-solar-panel text-4xl text-sky-600 mb-4"></i>
                    <h3 class="text-xl font-bold mb-2">Solar Powered</h3>
                    <p class="text-gray-600 text-sm">Eco-friendly campus with solar energy</p>
                </div>
                
                <div class="bg-gradient-to-br from-sky-100 to-blue-100 rounded-xl p-6 shadow-sm">
                    <i class="fas fa-wifi text-4xl text-sky-700 mb-4"></i>
    ...
    <section class="py-16 bg-gradient-to-br from-sky-50 to-blue-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-white rounded-2xl p-8 shadow-lg text-center border-t-4 border-sky-600">
                    <i class="fas fa-gamepad text-6xl text-sky-600 mb-6"></i>
                ...
                <div class="bg-white rounded-2xl p-8 shadow-lg text-center border-t-4 border-blue-600">
                    <i class="fas fa-star text-6xl text-blue-600 mb-6 font-bold"></i>
                    <h3 class="text-2xl font-bold mb-4 uppercase">Awe Inspiring</h3>
                    <p class="text-gray-600">Motivational and inspiring environment</p>
                </div>
                
                <div class="bg-white rounded-2xl p-8 shadow-lg text-center border-t-4 border-sky-700">
                    <i class="fas fa-film text-6xl text-sky-700 mb-6"></i>
                    <h3 class="text-2xl font-bold mb-4 uppercase">Entertainment</h3>
    ...
    <section class="py-24 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="bg-gradient-to-br from-sky-100 to-blue-100 rounded-xl p-6 text-center shadow-md">
                    <i class="fas fa-home text-5xl text-sky-600 mb-4"></i>
                    <h3 class="font-bold text-lg">Play Houses</h3>
                </div>
                
                <div class="bg-gradient-to-br from-blue-50 to-sky-100 rounded-xl p-6 text-center shadow-md">
                    <i class="fas fa-water text-5xl text-blue-600 mb-4"></i>
                    <h3 class="font-bold text-lg">Aquatics</h3>
                </div>
                
                <div class="bg-gradient-to-br from-sky-50 to-blue-100 rounded-xl p-6 text-center shadow-md">
                    <i class="fas fa-puzzle-piece text-5xl text-sky-700 mb-4"></i>
                    <h3 class="font-bold text-lg">Mazes</h3>
                </div>
                
                <div class="bg-gradient-to-br from-blue-100 to-sky-200 rounded-xl p-6 text-center shadow-md">
                    <i class="fas fa-tree text-5xl text-blue-700 mb-4"></i>
    ...
    <section class="py-16 bg-gradient-to-r from-sky-600 to-blue-600 text-white shadow-2xl">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <a href="/contact" class="bg-white text-sky-600 hover:bg-gray-100 px-8 py-4 rounded-xl font-bold text-lg transition inline-block shadow-lg">
...
export const SportsClubsPage = () => {
    ...
    <section class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
                <div class="bg-gradient-to-br from-sky-50 to-blue-50 rounded-2xl p-8 shadow-lg card-hover">
                    <div class="w-20 h-20 bg-white rounded-full flex items-center justify-center mx-auto mb-6">
                        <i class="fas fa-futbol text-4xl text-sky-600"></i>
                    </div>
                ...
                <div class="bg-gradient-to-br from-blue-50 to-sky-100 rounded-2xl p-8 shadow-lg card-hover">
                    <div class="w-20 h-20 bg-white rounded-full flex items-center justify-center mx-auto mb-6">
                        <i class="fas fa-table-tennis text-4xl text-sky-700"></i>
                    </div>
                ...
                <div class="bg-gradient-to-br from-sky-100 to-blue-50 rounded-2xl p-8 shadow-lg card-hover">
                    <div class="w-20 h-20 bg-white rounded-full flex items-center justify-center mx-auto mb-6">
                        <i class="fas fa-baseball-ball text-4xl text-blue-600"></i>
                    </div>
                ...
                <div class="bg-gradient-to-br from-sky-50 to-blue-50 rounded-2xl p-8 shadow-lg card-hover">
                    <div class="w-20 h-20 bg-white rounded-full flex items-center justify-center mx-auto mb-6">
                        <i class="fas fa-basketball-ball text-4xl text-sky-600"></i>
                    </div>
                ...
                <div class="bg-gradient-to-br from-sky-50 to-sky-100 rounded-2xl p-8 shadow-lg card-hover border-b-4 border-sky-500 text-center">
                    <div class="w-20 h-20 bg-white rounded-full flex items-center justify-center mx-auto mb-6 shadow-md">
                        <i class="fas fa-volleyball-ball text-4xl text-sky-600"></i>
                    </div>
                    <h3 class="text-2xl font-bold text-center mb-4 text-gray-900">Volleyball</h3>
                    <p class="text-gray-600 text-center">Indoor and outdoor courts available</p>
                </div>
                
                <div class="bg-gradient-to-br from-blue-50 to-sky-50 rounded-2xl p-8 shadow-lg card-hover">
                    <div class="w-20 h-20 bg-white rounded-full flex items-center justify-center mx-auto mb-6">
                        <i class="fas fa-running text-4xl text-blue-600"></i>
                    </div>
                ...
                <div class="bg-gradient-to-br from-sky-50 to-blue-100 rounded-2xl p-8 shadow-lg card-hover border-b-4 border-sky-600 text-center">
                    <div class="w-20 h-20 bg-white rounded-full flex items-center justify-center mx-auto mb-6 shadow-md">
                        <i class="fas fa-swimmer text-4xl text-sky-600"></i>
                    </div>
                    <h3 class="text-2xl font-bold text-center mb-4 text-gray-900">Swimming</h3>
                    <p class="text-gray-600 text-center">Ozonized pool with trained coaches</p>
                </div>
                
                <div class="bg-gradient-to-br from-blue-100 to-sky-50 rounded-2xl p-8 shadow-lg card-hover">
                    <div class="w-20 h-20 bg-white rounded-full flex items-center justify-center mx-auto mb-6">
                        <i class="fas fa-dumbbell text-4xl text-blue-700"></i>
                    </div>
                ...
                <div class="bg-gradient-to-br from-sky-100 to-blue-100 rounded-2xl p-8 shadow-lg card-hover">
                    <div class="w-20 h-20 bg-white rounded-full flex items-center justify-center mx-auto mb-6">
                        <i class="fas fa-medal text-4xl text-sky-800"></i>
                    </div>
            ...
            <div class="bg-sky-50 rounded-2xl p-8 border border-sky-100">
                <h3 class="text-2xl font-bold text-center mb-6">Youth Leadership & Service</h3>
                <div class="grid md:grid-cols-3 gap-6 text-center">
                    <div>
                        <i class="fas fa-campground text-4xl text-sky-600 mb-4"></i>
                    ...
                    <div>
                        <i class="fas fa-certificate text-4xl text-sky-700 mb-4"></i>
    ...
    <section class="py-16 bg-gradient-to-br from-sky-50 to-blue-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="bg-white rounded-xl p-6 shadow-lg text-center card-hover border-t-4 border-sky-600">
                    <i class="fas fa-music text-5xl text-sky-600 mb-4"></i>
                    <h3 class="font-bold text-lg mb-2">Music Club</h3>
                    <p class="text-sm text-gray-600">Vocal & instrumental training</p>
                </div>
                
                <div class="bg-white rounded-xl p-6 shadow-lg text-center card-hover border-t-4 border-blue-600">
                    <i class="fas fa-theater-masks text-5xl text-blue-600 mb-4"></i>
                    <h3 class="font-bold text-lg mb-2">Dance Club</h3>
                    <p class="text-sm text-gray-600">Classical, western, and folk forms</p>
                </div>
                
                <div class="bg-white rounded-xl p-6 shadow-lg text-center card-hover border-t-4 border-sky-500">
                    <i class="fas fa-palette text-5xl text-sky-500 mb-4"></i>
                    <h3 class="font-bold text-lg mb-2">Art Club</h3>
                    <p class="text-sm text-gray-600">Painting, drawing, and crafts</p>
                </div>
                
                <div class="bg-white rounded-xl p-6 shadow-lg text-center card-hover border-t-4 border-blue-700">
                    <i class="fas fa-drama text-5xl text-blue-700 mb-4"></i>
                    <h3 class="font-bold text-lg mb-2">Drama Club</h3>
                    <p class="text-sm text-gray-600">Theater and public speaking</p>
                </div>
                
                <div class="bg-white rounded-xl p-6 shadow-lg text-center card-hover border-t-4 border-sky-700">
                    <i class="fas fa-robot text-5xl text-sky-700 mb-4"></i>
    ...
    <section class="py-16 bg-gradient-to-r from-sky-600 to-blue-600 text-white shadow-2xl">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <a href="/admissions" class="bg-white text-sky-600 hover:bg-gray-100 px-8 py-4 rounded-xl font-bold text-lg transition inline-block shadow-lg">
...
export const BrochurePage = () => {
    ...
    ${PageHeader(
        'Digital Brochure',
        'Download our complete prospectus and learn more about SNS CAHS',
    ...
    <section class="py-16 bg-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-gradient-to-br from-sky-50 to-blue-50 rounded-2xl p-12 text-center shadow-xl border border-sky-100">
                <i class="fas fa-file-pdf text-8xl text-sky-600 mb-8"></i>
                <h2 class="text-4xl font-bold mb-4">SNS CAHS Prospectus</h2>
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center mb-8">
                    <a href="https://snscahs.org/brochure/" target="_blank" class="bg-sky-600 hover:bg-sky-700 text-white px-8 py-4 rounded-xl font-bold text-lg transition inline-flex items-center justify-center shadow-lg">
                        <i class="fas fa-download mr-2"></i>
                        Download Brochure
                    </a>
                    <a href="https://snscahs.org/brochure/" target="_blank" class="bg-gray-900 hover:bg-black text-white px-8 py-4 rounded-xl font-bold text-lg transition inline-flex items-center justify-center shadow-lg">
                ...
                <p class="text-sm text-gray-600">
                    For printed copies, contact us at <a href="tel:+919629937861" class="text-sky-600 font-bold hover:underline">+91 96299 37861</a>
                </p>
            </div>
            ...
            <div class="mt-12 grid md:grid-cols-3 gap-8">
                <div class="text-center">
                    <div class="w-16 h-16 bg-sky-100 rounded-full flex items-center justify-center mx-auto mb-4">
                        <i class="fas fa-graduation-cap text-3xl text-sky-600"></i>
                    </div>
                    <h3 class="font-bold text-lg mb-2">Academic Programs</h3>
                    <p class="text-sm text-gray-600">Professional Healthcare curriculum details</p>
                </div>
                ...
                <div class="text-center">
                    ...
                    <p class="text-sm text-gray-600">Complete clinical infrastructure overview</p>
                </div>
                
                <div class="text-center">
                    <div class="w-16 h-16 bg-sky-100 rounded-full flex items-center justify-center mx-auto mb-4">
                        <i class="fas fa-rupee-sign text-3xl text-sky-600"></i>
                    </div>
