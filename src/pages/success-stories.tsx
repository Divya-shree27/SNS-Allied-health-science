...
export const SuccessStoriesPage = () => {
    ...
    ${PageHeader(
        ...
        '/static/images/SNS College of Allied Health Science Web/Success.webp',
        'Success Stories'
    )}
    ...
    <section class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-gradient-to-br from-sky-100 to-blue-100 rounded-3xl overflow-hidden shadow-2xl">
                <div class="grid lg:grid-cols-2 gap-8">
                    ...
                    <div class="p-8 lg:p-12 flex flex-col justify-center">
                        <div class="inline-flex items-center bg-sky-600 text-white px-4 py-2 rounded-full text-sm font-semibold mb-4 w-fit">
                            <i class="fas fa-star mr-2"></i>
                            Featured Story
                        </div>
                        <h2 class="text-4xl font-bold text-gray-900 mb-4">Book of Record Achievement</h2>
                        <p class="text-gray-700 text-lg mb-6 leading-relaxed">
                            The Dinamalar Pattam – Final Round was successfully held at SNS College of Allied Health Science. The event concluded on a high note with prizes presented by Pavan Kumar, District Collector, Coimbatore, along with Dr. Nalin, Technical Director, SNS Institutions.
                        </p>
                        <div class="flex items-center text-sm text-gray-600 mb-6">
                            <span class="font-semibold mr-4">SNS CAHS</span>
                            <span class="mr-4">•</span>
                            <span>Award Ceremony</span>
                            <span class="mr-4 ml-4">•</span>
                            <span>Jan 2026</span>
                        </div>
                        <a href="https://www.instagram.com/p/DTuh-S0D-N0/" target="_blank" rel="noopener noreferrer" class="inline-flex items-center text-sky-600 hover:text-sky-700 font-bold">
    ...
    <section class="py-8 bg-gray-50 border-y">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-wrap items-center justify-center gap-4">
                <button id="tab-all" class="tab-button px-6 py-2 bg-sky-600 text-white rounded-full font-semibold hover:bg-sky-700 transition">All Stories</button>
    ...
    <script>
        ...
        const stories = {
            academic: [
                {
                    ...
                    description: "The Dinamalar Pattam – Final Round was successfully held at SNS College of Allied Health Science. The event concluded on a high note with prizes presented by Pavan Kumar, District Collector, Coimbatore, along with Dr. Nalin, Technical Director, SNS Institutions.",
                ...
                },
                {
                    ...
                    description: "Hats off to S. Lakshan, our student at SNS CAHS for dominating the board and emerging as the Champion at the District Level Children's Chess Tournament! His strategic mind and focus are truly remarkable. We are thrilled to celebrate his brilliant victory! Way to go, Lakshan!",
            ...
            sports: [
                {
                    ...
                    description: "We are proud to applaud D. Akshara for her remarkable achievement at the State Level Silambam Championship 2025, securing 2nd place! Her dedication, disciplined training, and skill in this ancient martial art truly inspire us. Congratulations, Akshara — keep shining and making SNS CAHS proud.",
            ...
            community: [
                {
                    title: "Nutrition & Wellness Awareness Drive",
                    description: "Our students of SNS CAHS organized an impactful Nutrition & Wellness Awareness Drive. Through hands-on demonstrations and patient counseling sessions, they explored the vital role of clinical nutrition in healing. This professional activity encouraged clinical reasoning, teamwork, and deeper awareness about public health—making learning both practical and socially meaningful!",
    ...
    <section class="py-16 bg-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-xl text-gray-600 mb-8">
                Join SNS College of Allied Health Science and become part of our legacy of excellence, innovation, and achievement!
            </p>
