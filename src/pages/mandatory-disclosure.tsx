...
export const MandatoryDisclosurePage = () => {
    ...
    ${PageHeader(
        ...
        'APPENDIX - IX | Regulatory Compliance',
                ...
                <table class="w-full border-collapse border border-gray-300">
                    ...
                    <tbody>
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="border border-gray-300 px-4 py-3">SNS COLLEGE OF ALLIED HEALTH SCIENCE</td>
                        </tr>
                        <tr class="hover:bg-gray-50">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="border border-gray-300 px-4 py-3 font-semibold">INSTITUTION CODE</td>
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="border border-gray-300 px-4 py-3 font-semibold">INSTITUTION EMAIL ID</td>
                            <td class="border border-gray-300 px-4 py-3"><a href="mailto:office@snscahs.org" class="text-sky-600 hover:underline">office@snscahs.org</a></td>
                        </tr>
                        <tr class="hover:bg-gray-50">
                            <td class="border border-gray-300 px-4 py-3">8</td>
                            <td class="border border-gray-300 px-4 py-3 font-semibold">CONTACT DETAILS</td>
                            <td class="border border-gray-300 px-4 py-3"><a href="tel:+919629937861" class="text-sky-600 hover:underline">+91 96299 37861</a></td>
                        </tr>
                    </tbody>
                </table>
            </div>
                ...
                <table class="w-full border-collapse border border-gray-300 bg-white">
                    ...
                    <tbody>
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="border border-gray-300 px-4 py-3"><a href="https://snscahs.org/affiliationUpgradation/" target="_blank" class="text-sky-600 hover:underline font-semibold">View Document</a></td>
                        </tr>
                        <tr class="hover:bg-gray-50">
                            <td class="border border-gray-300 px-4 py-3">2</td>
                            <td class="border border-gray-300 px-4 py-3">Copies of Trust Registration/Renewal Certificate</td>
                            <td class="border border-gray-300 px-4 py-3"><a href="https://snscahs.org/TRUST_DEED/" target="_blank" class="text-sky-600 hover:underline font-semibold">View Document</a></td>
                        </tr>
                        <tr class="hover:bg-gray-50">
                            <td class="border border-gray-300 px-4 py-3">3</td>
                            <td class="border border-gray-300 px-4 py-3">Copy of No Objection Certificate (NOC) Issued by State Govt.</td>
                            <td class="border border-gray-300 px-4 py-3"><a href="https://snscahs.org/noc/" target="_blank" class="text-sky-600 hover:underline font-semibold">View Document</a></td>
                        </tr>
                        <tr class="hover:bg-gray-50">
                            <td class="border border-gray-300 px-4 py-3">4</td>
                            <td class="border border-gray-300 px-4 py-3">Copies of Recognition Certificate Under RTE Act, 2009</td>
                            <td class="border border-gray-300 px-4 py-3"><a href="https://snscahs.org/recognitionCertificate/" target="_blank" class="text-sky-600 hover:underline font-semibold">View Document</a></td>
                        </tr>
                        <tr class="hover:bg-gray-50">
                            <td class="border border-gray-300 px-4 py-3">5</td>
                            <td class="border border-gray-300 px-4 py-3">Copy of Valid Building Safety Certificate</td>
                            <td class="border border-gray-300 px-4 py-3"><a href="https://cbse.snscahs.org/Building%20Safety%20certificate.pdf" target="_blank" class="text-sky-600 hover:underline font-semibold">View Document</a></td>
                        </tr>
                        <tr class="hover:bg-gray-50">
                            <td class="border border-gray-300 px-4 py-3">6</td>
                            <td class="border border-gray-300 px-4 py-3">Copy of Valid Fire Safety Certificate</td>
                            <td class="border border-gray-300 px-4 py-3"><a href="https://snscahs.org/FireSafetyCertificate/" target="_blank" class="text-sky-600 hover:underline font-semibold">View Document</a></td>
                        </tr>
                        <tr class="hover:bg-gray-50">
                            <td class="border border-gray-300 px-4 py-3">7</td>
                            <td class="border border-gray-300 px-4 py-3">Copy of DEO Certificate / Self Certificate</td>
                            <td class="border border-gray-300 px-4 py-3"><a href="https://snscahs.org/SelfCertification/" target="_blank" class="text-sky-600 hover:underline font-semibold">View Document</a></td>
                        </tr>
                        <tr class="hover:bg-gray-50">
                            <td class="border border-gray-300 px-4 py-3">8</td>
                            <td class="border border-gray-300 px-4 py-3">Copies of Valid Water, Health and Sanitation Certificates</td>
                            <td class="border border-gray-300 px-4 py-3"><a href="https://snscahs.org/WaterHealthSanitationCertificates/" target="_blank" class="text-sky-600 hover:underline font-semibold">View Document</a></td>
                        </tr>
                    </tbody>
                </table>
            </div>
    ...
    <section class="py-12 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="overflow-x-auto mb-8">
                <table class="w-full border-collapse border border-gray-300">
                    ...
                    <tbody>
                        <tr class="hover:bg-gray-50">
                            <td class="border border-gray-300 px-4 py-3">1</td>
                            <td class="border border-gray-300 px-4 py-3 font-semibold">Fee Structure of the Institution</td>
                            <td class="border border-gray-300 px-4 py-3"><a href="https://snscahs.org/FeeStructure/" target="_blank" class="text-sky-600 hover:underline font-semibold">View Document</a></td>
                        </tr>
                        <tr class="hover:bg-gray-50">
                            <td class="border border-gray-300 px-4 py-3">2</td>
                            <td class="border border-gray-300 px-4 py-3 font-semibold">Annual Academic Calendar</td>
                            <td class="border border-gray-300 px-4 py-3"><a href="https://snscahs.org/AcademicCalender/" target="_blank" class="text-sky-600 hover:underline font-semibold">View Document</a></td>
                        </tr>
                        <tr class="hover:bg-gray-50">
                            <td class="border border-gray-300 px-4 py-3">3</td>
                            <td class="border border-gray-300 px-4 py-3 font-semibold">List of College Management Committee</td>
                            <td class="border border-gray-300 px-4 py-3"><a href="https://snscahs.org/SchoolManagementCommittee/" target="_blank" class="text-sky-600 hover:underline font-semibold">View Document</a></td>
                        </tr>
                        <tr class="hover:bg-gray-50">
                            <td class="border border-gray-300 px-4 py-3">4</td>
                            <td class="border border-gray-300 px-4 py-3 font-semibold">List of Parents Teachers Association (PTA) Members</td>
                            <td class="border border-gray-300 px-4 py-3"><a href="https://snscahs.org/ParentsTeachersAssociation/" target="_blank" class="text-sky-600 hover:underline font-semibold">View Document</a></td>
                        </tr>
                        <tr class="hover:bg-gray-50">
                            <td class="border border-gray-300 px-4 py-3">5</td>
                            <td class="border border-gray-300 px-4 py-3 font-semibold">Last Three-Year Result of Board Examination</td>
                            <td class="border border-gray-300 px-4 py-3"><a href="https://snscahs.org/Three-YearResult/" target="_blank" class="text-sky-600 hover:underline font-semibold">View Document</a></td>
                        </tr>
                    </tbody>
                </table>
            </div>

            <h3 class="text-2xl font-bold mb-6 text-gray-900">Institutional Academic Results</h3>
            <div class="overflow-x-auto mb-8">
                <table class="w-full border-collapse border border-gray-300">
                    <thead class="bg-sky-200">
                        <tr>
                            <th class="border border-gray-300 px-4 py-3 text-left font-bold text-gray-900">Year</th>
                            <th class="border border-gray-300 px-4 py-3 text-left font-bold text-gray-900">Registered Students</th>
                            <th class="border border-gray-300 px-4 py-3 text-left font-bold text-gray-900">Students Passed</th>
                            <th class="border border-gray-300 px-4 py-3 text-left font-bold text-gray-900">Pass Percentage</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="border border-gray-300 px-4 py-3">30</td>
                            <td class="border border-gray-300 px-4 py-3 font-bold text-sky-600">100%</td>
                        </tr>
                        <tr class="hover:bg-gray-50">
            ...
            <h3 class="text-2xl font-bold mb-6 text-gray-900">Advance Academic Results</h3>
            <div class="overflow-x-auto">
                <table class="w-full border-collapse border border-gray-300">
                    <thead class="bg-sky-100">
                        <tr>
    ...
    <!-- E: Institution Infrastructure -->
    <section class="py-12 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 class="text-3xl font-bold mb-8 text-gray-900">E. Institution Infrastructure</h2>
                ...
                <table class="w-full border-collapse border border-gray-300">
                    ...
                    <tbody>
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="border border-gray-300 px-4 py-3"><span class="text-sky-600 font-bold text-sm">YES</span></td>
                        </tr>
                        <tr class="hover:bg-gray-50">
                            <td class="border border-gray-300 px-4 py-3">5</td>
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="border border-gray-300 px-4 py-3">7</td>
                            <td class="border border-gray-300 px-4 py-3 font-semibold">YouTube Video of Inspection</td>
                            <td class="border border-gray-300 px-4 py-3"><a href="https://youtu.be/rrJq-eqWxSc" target="_blank" class="text-sky-600 hover:underline font-semibold">Watch Video</a></td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-8">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-gray-600">Download the complete mandatory disclosure document as per regulatory guidelines</p>
                    </div>
                    <a href="https://snscahs.org/MandatoryDisclosurePDF/" target="_blank" class="bg-sky-600 hover:bg-sky-700 text-white px-6 py-3 rounded-lg font-bold transition inline-flex items-center">
    ...
    <!-- CTA -->
    <section class="py-16 bg-gradient-to-r from-sky-600 to-blue-600 text-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="/contact" class="bg-white text-sky-600 hover:bg-gray-100 px-8 py-3 rounded-lg font-bold transition">
